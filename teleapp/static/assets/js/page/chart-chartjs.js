...
const url='http://127.0.0.1:5000/my_chartdata';
fetch(url)
  .then(response => response.json())
  .then(chart_data => {
        console.log(chart_data.labels);
        fetchchart2(chart_data.data,chart_data.labels,chart_data.dataset)
  });



function fetchchart2(cdata,clabels,cdataset)
{
